...
/*
*	Funcție care aplica algoritmul lui Kruskal pentru gasirea unui arbore minim de acoperire pe un graf
*/
void Kruskal(Graph graph);

/*
*	Funcție care aplica algoritmul lui Prim pentru gasirea unui arbore minim de acoperire pe un graf si un nod de start
*/
